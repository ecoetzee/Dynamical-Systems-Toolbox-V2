function [f]=testfunction(t,u,da)
%
% Function for use in time histories to get continuation start points for Mehra's Aircraft B
%
%Created by S.Gill 02/12/2010

f=[];       % derivative values, same size as Ndim

%Tuens U Array into alpha, beta, p, q, and r.
alpha=u(1)*pi/180;
beta=u(2)*pi/180;
p=u(3)*pi/180;
q=u(4)*pi/180;
...
%Gives Values for the control surfaces
da=da*pi/180;
de=2*pi/180;
dr=0*pi/180;
