...
$Revision: 1.1.6.22 $  $Date: 2009/05/18 20:47:32 $
-->
...
<div class="header">
    <div class="left">
    <a href="matlab:XXXXXXXXXXXXX">Open <xsl:value-of select="m-file"/>.m in the Editor</a></div>
    <div class="right"><a href="matlab:YYYYYYYYYYYYY">Run in the Command Window</a></div>
    <!-- USE THIS:  <xsl:value-of select="$m-file"/> -->
</div>
<!-- Added the above -->
</xsl:template>
