% HB   list the values of the hopf functions generated from AUTO
%
%   HB to list the value of the “Hopf function” in the 
%   output-file fort.9. This function vanishes at a Hopf bifurcation 
%   point.
%       
%   HB('XXX') to list the value of the “Hopf function” in the 
%   data-file d.XXX. This function vanishes at a Hopf bifurcation point.
%
%   See also BP, EV, FL, IT, LP, NO, SP, ST, SZ
