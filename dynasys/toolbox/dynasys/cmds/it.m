% IT   list the number of Newton iterations per continuation step for AUTO
%      generated output file
%
%   IT to list the number of Newton iterations per continuation 
%   step in fort.9
%       
%   IT('XXX') to list the number of Newton iterations per continuation 
%   step in d.XXX
%
%   See also BP, EV, FL, HB, LP, NO, SP, ST, SZ
