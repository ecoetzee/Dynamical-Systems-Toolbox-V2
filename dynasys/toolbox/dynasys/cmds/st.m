% ST   list the number of stable eigenvalues per continuation step for AUTO
%      generated output file
%
%   ST to list the number of stable eigenvalues or stable 
%   Floquet multipliers per continuation step in fort.9.
%       
%   ST('XXX') to list the number of stable eigenvalues or stable 
%   Floquet multipliers per continuation step in d.XXX.
%
%   See also BP, EV, FL, HB, IT, LP, NO, SP, SZ
