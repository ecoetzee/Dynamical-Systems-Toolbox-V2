% EV   list the eignevalues of the Jacobian for AUTO generated output file
%
%   EV to list the eigenvalues of the Jacobian in fort.9 
%   (Algebraic problems).
%       
%   EV('XXX') to list the eigenvalues of the Jacobian in d.XXX 
%   (Algebraic problems).
% 
%   See also BP, FL, HB, IT, LP, NO, SP, ST, SZ 
