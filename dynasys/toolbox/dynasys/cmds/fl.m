% FL   list the Floquet multipliers in AUTO generated output file
%
%   FL to list the Floquet multipliers in the output-file fort.9 
%   (Differential equations).
%       
%   FL('XXX') to list the Floquet multipliers in the data-file 
%   d.XXX (Differential equations).
% 
%   See also BP, EV, HB, IT, LP, NO, SP, ST, SZ 
