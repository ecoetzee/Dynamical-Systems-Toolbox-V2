...
!
      USE AUTO_CONSTANTS, ONLY:FUNCFILENAME,ODIM,OUT,NOUTX,NPARX,NBIFX,N
     &IAP,NRAP
!    
      IMPLICIT NONE 
!
...
! 
      PRHS(3) = mxCreateNumericArray(1,1,mxClassIDFromClassName('int32')
     &,0) 
...
!
      USE AUTO_CONSTANTS,ONLY:STPNTFILENAME,PARDST0,UDST0,OUTDST0,ODIM,O
     &UT,NOUTX,NPARX,NBIFX,NIAP,NRAP,RUNMODEDST,IPS
!
...
!
      LOGICAL, EXTERNAL :: NUMSTAB       
!
      IF(RUNMODEDST == 0.OR.IPS==-2.OR.IPS==14.OR.IPS==16.OR.IPS==17)THE
     &N
       GOTO 201
      ELSE
       GOTO 202
...
!      
      USE AUTO_CONSTANTS, ONLY:BCNDFILENAME,ODIM,OUT,NOUTX,NPARX,NBIFX,N
     &IAP,NRAP  
!    
! Arguments
! 
...
! Define the derivatives flag variable in MATLAB environment 
! 
      PRHS(4) = mxCreateNumericArray(1,1,mxClassIDFromClassName('int32')
     &,0) 
...
!          
      USE AUTO_CONSTANTS, ONLY:ICNDFILENAME,ODIM,OUT,NOUTX,NPARX,NBIFX,N
     &IAP,NRAP     
!
! MATLAB MX AND MEX FUNCTIONS AND POINTERS
      mwPointer MSGptr
