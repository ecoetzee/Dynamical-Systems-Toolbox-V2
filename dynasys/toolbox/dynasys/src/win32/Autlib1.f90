...
!
      SUBROUTINE AUTO()
!
      USE AUTO_CONSTANTS, ONLY:NPARX,NBIFX,NIAP,NRAP,FORT2DST,FORT3DST,F
     &ORT7DST,FORT8DST,FORT9DST
!
...
!
      USE AUTO_CONSTANTS, ONLY:NPARX,NBIFX,NIAP,NRAP,FORT7DST,FORT
     &8DST,FORT9DST
!
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
!
...
!
      USE AUTO_CONSTANTS, ONLY:NPARX,NBIFX,NIAP,NRAP,FORT7DST,FORT8DST,F
     &ORT9DST
!
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
!
...
!
     ...
     &OUTF7,oldOUTF7,ODIM,OUT,NPARX,NBIFX,NIAP,NRAP,FORT7DST,FORT8DST,FO
     &RT9DST,RUNMODEDST
!      INCLUDE 'auto.h'
!
      IMPLICIT NONE
...
!  
     ...
     &PSF8,oldUDOTPSF8,NPARX,NBIFX,NIAP,NRAP,FORT7DST,FORT8DST,FORT9DST,
     &RUNMODEDST
!      INCLUDE 'auto.h'  
!
!      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
...
!
      USE AUTO_CONSTANTS, ONLY:IBRF8,MTOTF8,ITPF8,LABF8,NFPRF8,ISWF8,NTP
     &LF8,NARF8,NROWPRF8,ILAB,FORT3DST   
!      
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
      INTEGER I,M
!
...
!
      USE AUTO_CONSTANTS, ONLY:ILAB,IBRF8,MTOTF8,ITPF8,LABF8,NFPRF8,ISWF
     &8,NTPLF8,NARF8,NROWPRF8,NTSTF8,NCOLF8,NPARXF8,TF8,UF8,PARF8,NPARX,
...
!
      USE AUTO_CONSTANTS, ONLY:IBRF8,MTOTF8,ITPF8,LABF8,NFPRF8,ISWF8,NTP
     &LF8,NARF8,NROWPRF8,ILAB,NTSTF8,NCOLF8,NPARXF8,TMF8,UPSF8,IFPRF8,RL
     &DOTF8,UDOTPSF8,PARF8,NPARX,NBIFX,NIAP,NRAP         
!      INCLUDE 'auto.h'
!
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
      CHARACTER(10000) MATLABDISPSTR
...
!
      ...
      ELSE        
       R=SIZE(RLDOTF8,1)
       IF( R == 0 ) THEN
         CALL AUTOSTOPWITHERROR("Property Rldot in object F8 is not defi
     &ned")
       ENDIF
       DO I=1,NFPRF8(ILAB)
...
!
     ...
     &dNCOLF8,NPARXF8,oldNPARXF8,IFPRF8,oldIFPRF8,TF8,oldTF8,TMF8,oldTMF
     &8,PARF8,oldPARF8,RLDOTF8,oldRLDOTF8,UF8,oldUF8,UPSF8,oldUPSF8,UDOT
     &PSF8,oldUDOTPSF8,UPSF8TMP,TMF8TMP,UDOTPSF8TMP,NPARX,NBIFX,NIAP,NRA
     &P,FORT7DST,FORT8DST,FORT9DST,RUNMODEDST  
!      INCLUDE 'auto.h'
!
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
!
