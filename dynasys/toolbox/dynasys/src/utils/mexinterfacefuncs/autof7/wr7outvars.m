...
for i=1:length(F7)
    ...
    fprintf(fid,'      INTEGER,ALLOCATABLE :: %sF7%s\n',F7{i}{1},str);
    fprintf(fid,'      INTEGER,ALLOCATABLE :: old%sF7%s\n',F7{i}{1},str); 
    else
    fprintf(fid,'      DOUBLE PRECISION,ALLOCATABLE :: %sF7%s\n',F7{i}{1},str);
    fprintf(fid,'      DOUBLE PRECISION,ALLOCATABLE :: old%sF7%s\n',F7{i}{1},str);         
    end
