...
!
      IF( mxIsChar(RUNMODEptr1) == 0 ) THEN
        CALL AUTOSTOPWITHERROR("Property RunMode is not a character array")
      ENDIF
!
      STR=''
...
!
      IF( mxIsChar(FUNCFILENAMEptr1) == 0 ) THEN
        CALL AUTOSTOPWITHERROR("Property FuncFileName is not a character array")
      ENDIF
!
...
!
      IF( mxIsChar(STPNTFILENAMEptr1) == 0 ) THEN
        CALL AUTOSTOPWITHERROR("Property StpntFileName is not a character array")
      ENDIF
!
...
!
      IF( mxIsChar(BCNDFILENAMEptr1) == 0 ) THEN
        CALL AUTOSTOPWITHERROR("Property BcndFileName is not a character array")
      ENDIF
!
...
!
      IF( mxIsChar(ICNDFILENAMEptr1) == 0 ) THEN
        CALL AUTOSTOPWITHERROR("Property IcndFileName is not a character array")
      ENDIF
!
...
!
      IF( mxIsChar(FOPTFILENAMEptr1) == 0 ) THEN
        CALL AUTOSTOPWITHERROR("Property FoptFileName is not a character array")
      ENDIF
!
...
!
      IF( mxIsChar(PVLSFILENAMEptr1) == 0 ) THEN
        CALL AUTOSTOPWITHERROR("Property PvlsFileName is not a character array")
      ENDIF
!
...
!
      IF( RL0ptr2 == 0)THEN
        CALL mexWarnMsgTxt('Lower bound Rl0 seems to be undefined. Setting &
             to defualt value of 0')
        RL0DST = 0
      ELSE       
...
!
      IF( RL1ptr2 == 0)THEN
         CALL mexWarnMsgTxt('Upper bound Rl1 seems to be undefined. Setting &
              to defualt value of 1')
        RL1DST = 1
      ELSE       
...
!
      IF( A0ptr2 == 0)THEN
         CALL mexWarnMsgTxt('Lower bound A0 seems to be undefined. Setting & 
              to defualt value of 0')
        A0DST = 0
      ELSE       
...
!
      IF( A1ptr2 == 0)THEN
        CALL mexWarnMsgTxt('Upper bound A1 seems to be undefined. Setting &
             to defualt value of 1')
        A1DST = 1
      ELSE       
...
!
      IF( ITMXptr2 == 0)THEN
        CALL mexWarnMsgTxt('Maximum number of ierations for Itmx seems to &
             be undefined. Setting to defualt value of 8.')
        ITMXDST = 8
      ELSE        
...
!
      IF( DSMINptr2 == 0)THEN
        CALL mexWarnMsgTxt('Property Dsmin seems to be undefined. Setting &
             to 0.01*Ds.')
...
!
      IF( DSMAXptr2 == 0)THEN
        CALL mexWarnMsgTxt('Property Dsmax seems to be undefined. Setting &
             to 100*Ds.')
        DSMAXDST = ABS(100*DS)
      ELSE       
...
!
      ...
      IF( m /= NDIMDST .AND. IPSDST /= 2) THEN
        CALL AUTOSTOPWITHERROR("Mismatch between Ndim and size of U0 &
             defined in autoconstants object")       
      ENDIF
!
! Assign Out0 values -------------- 
...
!
      IF( mxIsInt32(IBRF8ptr1) == 0 ) THEN
        CALL AUTOSTOPWITHERROR("Property Ibr in object F8 is not an integer")
      ENDIF
!
...
!
      IF( mxIsInt32(MTOTF8ptr1) == 0 ) THEN
        CALL AUTOSTOPWITHERROR("Property Mtot in object F8 is not an integer")
      ENDIF
!
...
!
      IF( mxIsInt32(ITPF8ptr1) == 0 ) THEN
        CALL AUTOSTOPWITHERROR("Property Itp in object F8 is not an integer")
      ENDIF
!
...
!
      IF( mxIsInt32(LABF8ptr1) == 0 ) THEN
        CALL AUTOSTOPWITHERROR("Property Lab in object F8 is not an integer")
      ENDIF
!
...
!
      IF( mxIsInt32(NFPRF8ptr1) == 0 ) THEN
        CALL AUTOSTOPWITHERROR("Property Nfpr in object F8 is not an integer")
      ENDIF
!
...
!
      IF( mxIsInt32(ISWF8ptr1) == 0 ) THEN
        CALL AUTOSTOPWITHERROR("Property Isw in object F8 is not an integer")
      ENDIF
!
...
!
      IF( mxIsInt32(NTPLF8ptr1) == 0 ) THEN
        CALL AUTOSTOPWITHERROR("Property Ntpl in object F8 is not an integer")
      ENDIF
!
...
!
      IF( mxIsInt32(NARF8ptr1) == 0 ) THEN
        CALL AUTOSTOPWITHERROR("Property Nar in object F8 is not an integer")
      ENDIF
!
...
!
      IF( mxIsInt32(NROWPRF8ptr1) == 0 ) THEN
        CALL AUTOSTOPWITHERROR("Property Nrowpr in object F8 is not an integer")
      ENDIF
!
...
!
      IF( mxIsInt32(NTSTF8ptr1) == 0 ) THEN
        CALL AUTOSTOPWITHERROR("Property Ntst in object F8 is not an integer")
      ENDIF
!
...
!
      IF( mxIsInt32(NCOLF8ptr1) == 0 ) THEN
        CALL AUTOSTOPWITHERROR("Property Ncol in object F8 is not an integer")
      ENDIF
!
...
!
      IF( mxIsInt32(NPARXF8ptr1) == 0 ) THEN
        CALL AUTOSTOPWITHERROR("Property Nparx in object F8 is not an integer")
      ENDIF
!
...
!
      IF( mxIsInt32(IFPRF8ptr1) == 0 ) THEN
        CALL AUTOSTOPWITHERROR("Property Ifpr in object F8 is not an integer")
      ENDIF
!
...
!
      IF( mxIsDouble(PARF8ptr1) == 0 ) THEN
        CALL AUTOSTOPWITHERROR("Property Par in object F8 is not a double")
      ENDIF
!
...
!
      IF( mxIsDouble(RLDOTF8ptr1) == 0 ) THEN
        CALL AUTOSTOPWITHERROR("Property Rldot in object F8 is not a double")
      ENDIF
!
...
!
      IF( mxIsDouble(UPSF8ptr1) == 0 ) THEN
        CALL AUTOSTOPWITHERROR("Property Ups in object F8 is not a double")
      ENDIF
!
...
!
      IF( mxIsDouble(UDOTPSF8ptr1) == 0 ) THEN
        CALL AUTOSTOPWITHERROR("Property Udotps in object F8 is not a double")
      ENDIF
!
...
!
      ...
      IF( .NOT.ASSOCIATED(IBRF7MWS) ) THEN
        CALL AUTOSTOPWITHERROR("Internal error pointing to Ibr pointer data")
      ENDIF
!
      DO I=1,M
        IBRF7MWS(I)=IBRF7(I)
...
!
      ...
      IF( .NOT.ASSOCIATED(MTOTF7MWS) ) THEN
        CALL AUTOSTOPWITHERROR("Internal error pointing to Mtot pointer data")
      ENDIF
!
      DO I=1,M
...
!
      ...
      IF( .NOT.ASSOCIATED(ITPF7MWS) ) THEN
        CALL AUTOSTOPWITHERROR("Internal error pointing to Itp pointer data")
      ENDIF
!
      DO I=1,M
        ITPF7MWS(I)=ITPF7(I)
...
!
      ...
      IF( .NOT.ASSOCIATED(LABF7MWS) ) THEN
        CALL AUTOSTOPWITHERROR("Internal error pointing to Lab pointer data")
      ENDIF
!
      DO I=1,M
        LABF7MWS(I)=LABF7(I)
...
!
      ...
      IF( .NOT.ASSOCIATED(PARF7MWS) ) THEN
        CALL AUTOSTOPWITHERROR("Internal error pointing to Par pointer data")
      ENDIF
!
      DO I=1,M
        DO J=1,N
...
!
      ...
      IF( .NOT.ASSOCIATED(VAXISF7MWS) ) THEN
        CALL AUTOSTOPWITHERROR("Internal error pointing to L2norm pointer data")
      ENDIF
!
      DO I=1,M
...
!
      ...
      IF( .NOT.ASSOCIATED(UF7MWS) ) THEN
        CALL AUTOSTOPWITHERROR("Internal error pointing to U pointer data")
      ENDIF
!
      DO I=1,M
        DO J=1,N
...
!
      ...
      IF( N > 0 ) THEN
         ...
         IF( .NOT.ASSOCIATED(OUTF7MWS) ) THEN
            CALL AUTOSTOPWITHERROR("Internal error pointing to Out pointer data")
         ENDIF
         !
         DO I=1,M
            DO J=1,N
...
!
      ...
      IF( .NOT.ASSOCIATED(NFPRF8MWS) ) THEN
        CALL AUTOSTOPWITHERROR("Internal error pointing to Nfpr pointer data")
      ENDIF
!
      DO I=1,M
...
!
      ...
      IF( .NOT.ASSOCIATED(ISWF8MWS) ) THEN
        CALL AUTOSTOPWITHERROR("Internal error pointing to Isw pointer data")
      ENDIF
!
      DO I=1,M
        ISWF8MWS(I)=ISWF8(I)
...
!
      ...
      IF( .NOT.ASSOCIATED(NTPLF8MWS) ) THEN
        CALL AUTOSTOPWITHERROR("Internal error pointing to Ntpl pointer data")
      ENDIF
!
      DO I=1,M
...
!
      ...
      IF( .NOT.ASSOCIATED(NARF8MWS) ) THEN
        CALL AUTOSTOPWITHERROR("Internal error pointing to Nar pointer data")
      ENDIF
!
      DO I=1,M
        NARF8MWS(I)=NARF8(I)
...
!
      ...
      IF( .NOT.ASSOCIATED(NROWPRF8MWS) ) THEN
        CALL AUTOSTOPWITHERROR("Internal error pointing to Nrowpr pointer data")
      ENDIF
!
      DO I=1,M
...
!
      ...
      IF( .NOT.ASSOCIATED(NTSTF8MWS) ) THEN
        CALL AUTOSTOPWITHERROR("Internal error pointing to Ntst pointer data")
      ENDIF
!
      DO I=1,M
...
!
      ...
      IF( .NOT.ASSOCIATED(NCOLF8MWS) ) THEN
        CALL AUTOSTOPWITHERROR("Internal error pointing to Ncol pointer data")
      ENDIF
!
      DO I=1,M
...
!
      ...
      IF( .NOT.ASSOCIATED(NPARXF8MWS) ) THEN
        CALL AUTOSTOPWITHERROR("Internal error pointing to Nparx pointer data")
      ENDIF
!
      DO I=1,M
...
!
      ...
      IF(N > 0)  THEN
         ...
         IF( .NOT.ASSOCIATED(IFPRF8MWS) ) THEN
            CALL AUTOSTOPWITHERROR("Internal error pointing to Ifpr pointer data")
         ENDIF
...
!
      ...
      IF ( M > 0 ) THEN
         ...
         IF( .NOT.ASSOCIATED(TF8MWS) ) THEN
            CALL AUTOSTOPWITHERROR("Internal error pointing to T pointer data")
         ENDIF
         !
         DO I=1,M
            TF8MWS(I)=TF8(I)
...
!
      ...
      IF( N >0 ) THEN
         ...
         IF( .NOT.ASSOCIATED(TMF8MWS) ) THEN
            CALL AUTOSTOPWITHERROR("Internal error pointing to Tm pointer data")
         ENDIF
         !
         DO I=1,M
            DO J=1,N
...
!
      ...
      IF ( N > 0 ) THEN
         ...
         IF( .NOT.ASSOCIATED(RLDOTF8MWS) ) THEN
            CALL AUTOSTOPWITHERROR("Internal error pointing to Rldot pointer data")
         ENDIF
!
         DO I=1,M
            DO J=1,N
...
!
      ...
      IF ( O > 0 ) THEN
         ...
         IF( .NOT.ASSOCIATED(UPSF8MWS) ) THEN
            CALL AUTOSTOPWITHERROR("Internal error pointing to Ups pointer data")
         ENDIF
         !
         DO I=1,M
            DO J=1,N
...
!
      ...
      IF ( O > 0 ) THEN
         ...
         IF( .NOT.ASSOCIATED(UDOTPSF8MWS) ) THEN
            CALL AUTOSTOPWITHERROR("Internal error pointing to Udotps pointer data")
         ENDIF
         !
         DO I=1,M
            DO J=1,N
